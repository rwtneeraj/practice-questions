...
const productOf = function (numbers) {
  return numbers.reduce(function (accumulator, element) { return accumulator * element; }, 1);
};
...
const averageOf = function (numbers) {
  return numbers.reduce(function (accumulator, element) { return accumulator + element; }) / numbers.length;
};
...
const minOf = function (numbers) {
  return numbers.reduce(function (acc, element) { return Math.min(acc, element); }, Infinity);
};
...
const maxOf = function (numbers) {
  return numbers.reduce(function (acc, element) { return Math.max(acc, element); }, -Infinity);
};
...
const sumPositiveNumbers = function (numbers) {
  return numbers.reduce(function (acc, element) { return element > 0 ? acc + element : acc; }, 0);
};
...
const sumOfSquares = function (numbers) {
  return numbers.reduce(function (acc, element) { return acc + element * element; }, 0);
};
